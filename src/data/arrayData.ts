export const arrayData = [
  ...
  {x: 0, y: 5, piece: 'z',  playable: true, highlighted: false, king: false , selected: false, movable: true},
  ...
  {x: 3, y: 4, piece: 'x',  playable: true, highlighted: false, king: false  , selected: false, movable: true},
  ...
  {x: 6, y: 3, piece: 'x',  playable: true, highlighted: false, king: false  , selected: false, movable: true},
  ...
  {x: 2, y: 1, piece: null,  playable: true, highlighted: false, king: false , selected: false, movable: true},
  ...
  {x: 6, y: 1, piece: 'x',  playable: true, highlighted: false, king: false , selected: false, movable: true},
